...
class StoreBankServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'products' => ['required_unless:service_type,stat,deposit', 'array'],
            'products.*' => ['required_unless:service_type,stat,deposit', 'string', 'max:255'],
