        ...
        return [
            ...
            'footerLinks' => [
                ...
                'regulatory' => [
                    ...
                    'sbp' => env('SBP', 'https://www.sbp.org.pk'),
                    'banking_mohtasib' => env('BANKING_MOHTASIB', 'https://www.bankingmohtasib.gov.pk'),
                    'secp' => env('SECP', 'https://www.secp.gov.pk'),
                    'goajk' => env('GOAJK', 'https://www.ajk.gov.pk'),
                    'gopak' => env('GOPAK', 'https://www.pakistan.gov.pk'),
                    'ajk_tourism' => env('AJK_TOURISM', 'https://tourism.ajk.gov.pk'),
