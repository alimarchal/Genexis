...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: route('bod-committees.create') },
];
...
export default function CreateBodCommittee({ boardMembers, managementMembers }: Props) {
    const { data, setData, processing, errors } = useForm({
        name: '',
        description: '',
        chairman_board_id: 'none',
        secretary_board_id: '',
        secretary_management_id: '',
        board_members: [] as number[],
        management_members: [] as number[],
    ...
    const submit: FormEventHandler = (e) => {
        ...
        router.post(route('bod-committees.store'), formData);
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create BOD Committee" />

            <div className="px-10 py-6">
                <Heading title="Create BOD Committee" description="Add a new Board of Directors committee" />
