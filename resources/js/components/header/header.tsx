                                ...
                                <button
                                    className={
                                        isMobile
                                            ...
                                            : 'relative flex w-full items-center justify-between text-left text-[16px] font-normal text-slate-900 after:absolute after:-bottom-0.5 after:left-0 after:h-[2px] after:w-0 after:bg-[#F9B912] after:transition-all after:duration-300 after:content-[""] hover:text-[#F9B912] hover:after:w-full'
                                    }
                                >
                                    {child.title}
                            ...
                            <a
                                ...
                                className={
                                    isMobile
                                        ...
                                        : 'relative block text-[16px] font-normal text-slate-900 after:absolute after:-bottom-0.5 after:left-0 after:h-[2px] after:w-0 after:bg-[#F9B912] after:transition-all after:duration-300 after:content-[""] hover:text-[#F9B912] hover:after:w-full'
                                }
                                role="menuitem"
                            >
                                {child.title}
            ...
            <header className="relative flex min-h-[70px] border-b border-gray-300 bg-gradient-to-r from-[#e9f7ef] to-[#fff7e6] tracking-wide shadow-[0_4px_12px_0_rgba(0,0,0,0.07)]">
                <div className="relative flex w-full items-center px-6 py-0 sm:px-10">
                    ...
                    <div className="flex flex-1 items-center justify-center lg:w-[65%]">
                        ...
                        {/* Desktop Menu */}
                        <nav className="hidden lg:flex lg:items-center lg:gap-x-2 lg:rounded-xl lg:bg-gradient-to-r lg:from-[#e9f7ef] lg:to-[#fff7e6] lg:px-3 lg:py-2 xl:gap-x-3 xl:px-4 xl:py-2 2xl:gap-x-5 2xl:px-5 2xl:py-2.5">
