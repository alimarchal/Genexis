                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden lg:flex items-center ml-6 h-full">
                            <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-lg border border-blue-100 shadow-sm">
                                ...
                                <div>
                                    <p className="text-xs text-gray-600">Requesting A Call:</p>
                                    <a href="tel:+925822924244" className="text-blue-700 font-semibold text-[15px] hover:text-blue-800">+92-5822-924244</a>
                                </div>
                            </div>
                        </div>
                    </div>
