...
const ServicesPage = () => {
    ...
    const services: Service[] = [
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                    <path d="M35 15H30V12.5C30 11.1739 29.4732 9.90215 28.5355 8.96447C27.5979 8.02678 26.3261 7.5 25 7.5H15C13.6739 7.5 12.4021 8.02678 11.4645 8.96447C10.5268 9.90215 10 11.1739 10 12.5V15H5C4.33696 15 3.70107 15.2634 3.23223 15.7322C2.76339 16.2011 2.5 16.837 2.5 17.5V30C2.5 30.663 2.76339 31.2989 3.23223 31.7678C3.70107 32.2366 4.33696 32.5 5 32.5H35C35.663 32.5 36.2989 32.2366 36.7678 31.7678C37.2366 31.2989 37.5 30.663 37.5 30V17.5C37.5 16.837 37.2366 16.2011 36.7678 15.7322C36.2989 15.2634 35.663 15 35 15ZM12.5 12.5C12.5 11.837 12.7634 11.2011 13.2322 10.7322C13.7011 10.2634 14.337 10 15 10H25C25.663 10 26.2989 10.2634 26.7678 10.7322C27.2366 11.2011 27.5 11.837 27.5 12.5V15H12.5V12.5ZM35 30H5V17.5H35V30Z" fill="currentColor" />
                    <path d="M20 20C18.6739 20 17.4021 20.5268 16.4645 21.4645C15.5268 22.4021 15 23.6739 15 25C15 26.3261 15.5268 27.5979 16.4645 28.5355C17.4021 29.4732 18.6739 30 20 30C21.3261 30 22.5979 29.4732 23.5355 28.5355C24.4732 27.5979 25 26.3261 25 25C25 23.6739 24.4732 22.4021 23.5355 21.4645C22.5979 20.5268 21.3261 20 20 20ZM20 27.5C19.337 27.5 18.7011 27.2366 18.2322 26.7678C17.7634 26.2989 17.5 25.663 17.5 25C17.5 24.337 17.7634 23.7011 18.2322 23.2322C18.7011 22.7634 19.337 22.5 20 22.5C20.663 22.5 21.2989 22.7634 21.7678 23.2322C22.2366 23.7011 22.5 24.337 22.5 25C22.5 25.663 22.2366 26.2989 21.7678 26.7678C21.2989 27.2366 20.663 27.5 20 27.5Z" fill="currentColor" />
                </svg>
            ),
            attributes: [
                { id: 20, attribute_name: "Inter Bank Settlements", attribute_value: "Arrangements with major scheduled banks for settlements and outward remittances", sort_order: 1 },
                { id: 21, attribute_name: "HBL Partnership", attribute_value: "All Banker Cheques issued by BAJK branches payable on all HBL branches", sort_order: 2 },
                { id: 22, attribute_name: "MoneyGram Service", attribute_value: "Global money transfer with 350,000+ locations in 200+ countries. Find locations: https://www.moneygram.com/locations", sort_order: 3 },
                { id: 23, attribute_name: "RIA Money Transfer", attribute_value: "World's largest money transfer service in 147+ countries with 287,000+ locations. Find locations: https://www.riamoneytransfer.com/ria-locator", sort_order: 4 },
                { id: 24, attribute_name: "Western Union", attribute_value: "Financial services company offering money transfers in 200+ countries since 1851. Online, in-person, and phone services available", sort_order: 5 },
                { id: 25, attribute_name: "Home Remittance Facility", attribute_value: "Customers can receive home remittances from all bank branches", sort_order: 6 },
                        ...
                        {services.map((service, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className={`font-medium text-sm sm:text-base ${activeServiceIndex === index ? 'text-[#4A7C59]' : 'text-gray-700'
                                        }`}>
                                        {service.name}
                                    </span>
                                </button>
                        ...
                        <div className="bg-gradient-to-r from-[#4A7C59] via-[#5D8A6A] to-[#6B9B7A] px-8 py-6 relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-6 relative z-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/90 mt-2">{activeService.description}</p>
                                </div>
                            </div>
