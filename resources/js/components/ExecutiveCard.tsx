...
const ExecutiveCard: React.FC<ExecutiveCardProps> = ({
    ...
    return (
        <div className="mx-auto w-full max-w-sm">
            <div
                className="relative transform overflow-hidden rounded-xl border border-gray-100 bg-white shadow-lg transition-all duration-500 ease-in-out hover:-translate-y-2 hover:scale-105 hover:shadow-2xl"
                ...
                <div className="p-6 sm:p-8">
                    <div className="space-y-4 text-center">
                        ...
                        <div className="relative">
                            <p className="transform text-sm font-semibold text-gray-600 transition-all duration-300 sm:text-base">{title}</p>
                            <div
