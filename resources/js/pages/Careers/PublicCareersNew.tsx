                    ...
                    <div className="mx-auto max-w-7xl px-6 py-16">
                        <div className="text-center">
                            ...
                            <p className="mx-auto max-w-2xl text-xl text-blue-100">
                                Join our team and build your career with Bank of Azad Jammu & Kashmir
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    {careers.data.length > 0 ? (
                        <>
                            <div className="mb-8">
                                <p className="text-gray-600">
                                    Showing {careers.from || 0} to {careers.to || 0} of {careers.total} opportunities
                                </p>
                            </div>
                        ...
                        <div className="py-16 text-center">
                            <div className="mx-auto max-w-sm">
                                ...
                                <h3 className="mb-2 text-lg font-medium text-gray-900">No Current Openings</h3>
                                <p className="text-gray-600">There are currently no career opportunities available.</p>
                            </div>
                        </div>
                    )}
                </div>
