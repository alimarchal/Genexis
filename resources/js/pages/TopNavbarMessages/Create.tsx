...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: route('top-navbar-messages.create') },
];
...
export default function Create() {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        router.post(route('top-navbar-messages.store'), data);
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Top Navbar Message" />
            <div className="px-10 py-6">
                <Heading title="Create Top Navbar Message" description="Add a new message to the top navigation bar" />
                <div className="mt-8">
                    <form onSubmit={submit} className="space-y-8">
                        ...
                        <div className="flex justify-end gap-2">
                            ...
                            <Button type="submit" disabled={processing}>
                                ...
                                {processing ? 'Creating...' : 'Create Message'}
                            </Button>
                        </div>
                    </form>
                </div>
