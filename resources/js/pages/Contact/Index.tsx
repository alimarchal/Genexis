        ...
        <div className="min-h-screen bg-gradient-to-br from-[#e9f7ef] to-[#fff7e6]">
            <div className="mx-auto max-w-7xl px-6 py-8">
                ...
                <div className="mb-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    <div className="group relative transform cursor-pointer overflow-hidden rounded-2xl border border-green-200/20 bg-gradient-to-br from-[#4A7C59] via-[#5a8a69] to-[#6B9B7A] p-8 text-center shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-500 ease-out hover:-translate-y-3 hover:shadow-[0_20px_60px_rgb(74,124,89,0.4)]">
                ...
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
                    ...
                    <div className="relative transform overflow-hidden rounded-3xl border border-gray-100/50 bg-white shadow-[0_10px_40px_rgb(0,0,0,0.1)] transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-[0_20px_60px_rgb(0,0,0,0.15)]">
                        <div className="absolute inset-0 bg-gradient-to-br from-[#4A7C59]/5 via-transparent to-[#F9B912]/5"></div>
                        <div className="relative p-8">
                            <h2 className="mb-8 flex items-center text-3xl font-bold text-gray-800">
                                <div className="mr-4 rounded-2xl bg-gradient-to-br from-[#4A7C59] to-[#6B9B7A] p-3 shadow-[0_8px_20px_rgb(74,124,89,0.3)]">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                {/* Name Field */}
                                <div className="group">
                                    <label className="mb-3 block text-sm font-semibold text-gray-700 transition-colors group-hover:text-[#4A7C59]">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-xl border-2 border-gray-200 bg-gray-50/50 px-5 py-4 backdrop-blur-sm transition-all duration-300 hover:border-gray-300 hover:shadow-md focus:border-[#4A7C59] focus:ring-4 focus:ring-[#4A7C59]/20"
                                ...
                                <button
                                    ...
                                    className="group relative flex w-full transform items-center justify-center overflow-hidden rounded-xl bg-gradient-to-r from-[#4A7C59] via-[#5a8a69] to-[#6B9B7A] px-8 py-4 text-lg font-bold text-white shadow-[0_8px_25px_rgb(74,124,89,0.4)] transition-all duration-300 hover:-translate-y-1 hover:from-[#3d6b4a] hover:via-[#4a7c59] hover:to-[#5a8a69] hover:shadow-[0_15px_35px_rgb(74,124,89,0.6)] disabled:cursor-not-allowed disabled:opacity-50"
                                >
                        ...
                        <div className="relative transform overflow-hidden rounded-3xl border border-gray-100/50 bg-white shadow-[0_10px_40px_rgb(0,0,0,0.1)] transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-[0_20px_60px_rgb(0,0,0,0.15)]">
                            ...
                            <div className="relative p-8">
                                ...
                                <div className="space-y-6">
                                    <div className="group flex items-start rounded-2xl p-4 transition-all duration-300 hover:bg-gradient-to-r hover:from-[#4A7C59]/5 hover:to-transparent">
                                        <div className="mr-4 rounded-xl bg-gradient-to-br from-[#4A7C59] to-[#6B9B7A] p-3 shadow-[0_6px_15px_rgb(74,124,89,0.3)] transition-transform duration-300 group-hover:scale-110">
                                            <MapPin className="h-6 w-6 text-white" />
                                        </div>
                                        <div>
                                            <p className="mb-2 text-lg font-bold text-gray-800">Address</p>
                                            <p className="leading-relaxed text-gray-600">{contact_address}</p>
                                        </div>
                                    </div>

                                    <div className="group flex items-center rounded-2xl p-4 transition-all duration-300 hover:bg-gradient-to-r hover:from-[#4A7C59]/5 hover:to-transparent">
                            ...
                            <div className="relative p-8">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between rounded-2xl border border-gray-100 bg-gradient-to-r from-gray-50 to-white px-6 py-4 transition-all duration-300 hover:shadow-md">
                                        ...
                                        <span className="text-lg font-bold text-[#4A7C59]">9:00 AM - 5:00 PM</span>
                                    </div>
                                    <div className="flex items-center justify-between rounded-2xl border border-gray-100 bg-gradient-to-r from-gray-50 to-white px-6 py-4 transition-all duration-300 hover:shadow-md">
                                        <span className="text-lg font-bold text-gray-700">Friday</span>
                                        <span className="text-lg font-bold text-[#4A7C59]">9:00 AM - 05:30 PM</span>
                                    </div>
                                    <div className="flex items-center justify-between rounded-2xl border border-gray-100 bg-gradient-to-r from-gray-50 to-white px-6 py-4 transition-all duration-300 hover:shadow-md">
                                        <span className="text-lg font-bold text-gray-700">Saturday</span>
                                        <span className="text-lg font-bold text-[#4A7C59]">9:00 AM - 2:00 PM</span>
                                    </div>
                ...
                <div className="relative mt-20 transform overflow-hidden rounded-3xl shadow-[0_20px_60px_rgb(74,124,89,0.4)] transition-all duration-500 ease-out hover:-translate-y-2 hover:shadow-[0_30px_80px_rgb(74,124,89,0.6)]">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#4A7C59] via-[#5a8a69] to-[#6B9B7A]"></div>
                    ...
                    <div className="relative p-12 text-center text-white">
                        <div className="mx-auto max-w-4xl">
                            ...
                            <a
                                ...
                                className="group relative inline-flex transform items-center overflow-hidden rounded-2xl bg-white px-10 py-4 text-lg font-bold text-[#4A7C59] shadow-[0_10px_30px_rgb(0,0,0,0.3)] transition-all duration-300 hover:-translate-y-1 hover:bg-[#F9B912] hover:text-white hover:shadow-[0_15px_40px_rgb(0,0,0,0.4)]"
                            >
                                <div className="absolute inset-0 bg-gradient-to-r from-[#F9B912]/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
