...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create',
        href: route('product-scheme-attributes.create'),
    },
];
...
export default function CreateProductSchemeAttribute({ schemes }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        router.post(route('product-scheme-attributes.store'), data);
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="px-10 py-6">
                <Heading title="Create Scheme Attribute" description="Add a new attribute to a product scheme" />
