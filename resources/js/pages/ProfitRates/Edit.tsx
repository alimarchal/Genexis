...
export default function Edit({ profitRate }: Props) {
    const { data, setData, put, processing, errors } = useForm<ProfitRateForm>({
        category: profitRate.category,
        rate: profitRate.rate,
    ...
    const handleSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('profit-rates.update', profitRate.id));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Profit Rate - ${profitRate.category}`} />
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center space-x-4">
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Updating...' : 'Update Profit Rate'}
                                </Button>
