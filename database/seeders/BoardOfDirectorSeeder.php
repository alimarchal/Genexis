    ...
    public function run(): void
    {
        $boardMembers = [
            ...
            [
                ...
                'short_description' => 'Mr. Shahid Shehzad Mir is a seasoned banking professional with an illustrious career spanning several key leadership roles within the financial sector.',
                'full_biography' => 'Mr. Shahid Shehzad Mir is a seasoned banking professional with an illustrious career spanning several key leadership roles within the financial sector. Currently serving as the Executive Vice President and Chief Financial Officer (CFO) of The Bank of Azad Jammu & Kashmir, he brings a wealth of expertise in financial management, strategic leadership, and executive decision-making. Mr. Shahid Shehzad Mir commenced his journey with the Bank of Azad Jammu & Kashmir in 2006, initially joining as an OG-II. Through his unwavering commitment and diligent efforts, he progressively earned promotions within the organization. In 2014, in recognition of his hard work and dedication, Mr. Mir achieved the esteemed position of Divisional Head of the Financial Control Division and Treasury. Prior to joining Bank of AJK, he remained associated with Sehgal Group of Industries, Pakistan\'s one of the most reputed Business Group as Manager Finance. He has been looking after the Financial Control and Treasury Management of the Bank, playing a pivotal role in shaping and executing the bank\'s financial strategies. In addition to his core financial responsibilities, he holds significant leadership roles within the Bank. As Head of Finance & Treasury at the Head Office, he demonstrated exceptional financial acumen. His role extended to treasury functions, where he effectively managed day-to-day operations, investments in various financial instruments, and ensured robust and fund management. His meticulous approach to financial governance is evident from the Profitability of the Bank, which has been sky rocketed through viable investments. Mr. Shahid Shehzad Mir beings with him ample knowledge and experience of Commercial and Retail Banking, and in his previous role in the field of Business, he provided inspirational leadership ensuring the successful delivery of business plans. His academic journey reflects a commitment to continuous learning and professional development. Holding a Master\'s degree in Economics, and MBA in Finance, he has also earned diplomas and certifications in Islamic Banking and Finance and certified Islamic Fund Manager, further enhancing his expertise in this specialized domain. Recently assuming the charge of Acting President/CEO, Mr. Shahid Shehzad Mir brings a visionary approach to his leadership. Known for his strategic thinking and commitment to excellence, he is poised to steer The Bank of Azad Jammu & Kashmir towards new heights. His extensive experience, coupled with a comprehensive understanding of financial dynamics, positions him as a dynamic and capable leader ready to navigate the bank through evolving challenges and opportunities. Mr. Shahid Shehzad Mir\'s leadership philosophy revolves around fostering a culture of innovation, collaboration, and customer-centricity. As Acting President/CEO, he is dedicated to upholding the bank\'s legacy of trust, transparency, and service excellence, ensuring the continued success and growth of The Bank of Azad Jammu & Kashmir.',
                'experience' => [
            ...
            [
                ...
                'achievements' => [
                    'Formation of Human Resource Development Network',
                    'Strengthened institutions: TRDP, MRDP, SAFCOW, BRSP, KWO',
                    'Managed large-scale international development projects',
                    'Specialist in community mobilization and institutional development',
                ],
                'image' => 'bod/mubashar_nabi.jpg',
                'sort_order' => 6,
                'is_chairman' => false,
                'is_active' => true,
            ],
